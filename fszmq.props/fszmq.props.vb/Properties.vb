...
Namespace fszmq.props
  ...
  Public Class Properties
    ...
    Function CopyAltersTargetNotSource_Labels (ByVal msg1 As Message,
      ...
      Dim after As Func(Of Boolean) = Function () 
        msg1.Copy(msg2)
        Return msg2.Data().SequenceEqual(source)
      End Function
      
      Return after.Label("Source")                              _
    ...
    ''' </summary>
    <CheckProperty(Arbitrary := { GetType(Generators) })>
    Public Function CopyAltersTargetNotSource_Filtered (ByVal msg1 As Message,
                                                        ByVal msg2 As Message) As [Property]
        Dim source = msg1.Data()
        Dim before = msg2.Data()
        
        Dim doCopy As Func(Of Boolean) = Function ()
          msg1.Copy(msg2)
          Dim after = msg2.Data()
        ...
        Return doCopy.When(Not before.SequenceEqual(source))
    End Function
